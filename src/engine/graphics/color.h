...
namespace Color {
    ...
    const ColorRGBA MAGENTA         {{0xFF, 0x00, 0xFF, 0xFF}};
    const ColorRGBA CYAN            {{0x00, 0xFF, 0xFF, 0xFF}};
    const ColorRGBA YELLOW          {{0xFF, 0xFF, 0x00, 0xFF}};
    const ColorRGBA ORANGE          {{0xFF, 0x80, 0x00, 0xFF}};
    const ColorRGBA LIME            {{0xA8, 0xFF, 0x00, 0xFF}};
    const ColorRGBA BROWN           {{0x80, 0x40, 0x20, 0xFF}};
    const ColorRGBA VIOLET          {{0x8a, 0x29, 0xe2, 0xFF}};
