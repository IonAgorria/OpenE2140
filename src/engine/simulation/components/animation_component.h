...
//
#ifndef OPENE2140_ANIMATION_COMPONENT_H
#define OPENE2140_ANIMATION_COMPONENT_H
 ...
 */
CLASS_COMPONENT(Entity, AnimationComponent)
protected:
    /**
...
#endif //OPENE2140_ANIMATION_COMPONENT_H
